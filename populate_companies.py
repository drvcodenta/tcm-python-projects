...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        test_data = [
            {"name": "Google", "email": "hyoyenkyuma@gmail.com", "trademark": 0, "url": "https://www.google.com"},
            {"name": "Microsoft", "email": "hyoyenkyuma@gmail.com", "trademark": 0, "url": "https://www.microsoft.com"},
        ]
